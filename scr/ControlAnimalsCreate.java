    ...
    public void createRecordsAnimals(int numberMenuAnimals, String title) {
        switch (numberMenuAnimals) {
            ...
            case 3 -> {
                ...
                hamsters.setKind(dateAnimals[1]);
